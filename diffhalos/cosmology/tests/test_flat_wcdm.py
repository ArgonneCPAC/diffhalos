...
from .. import flat_wcdm, cosmo_params
...
try:
    ...
    DSPS_COSMO_LIST = [cosmo_params.PLANCK15, cosmo_params.WMAP5]
except ImportError:
    HAS_ASTROPY = False
...
def test_flat_lcdm():
    ...
    for cosmo in ASTROPY_COSMO_LIST:
        cosmo_dsps = cosmo_params.CosmoParams(cosmo.Om0, -1, 0, cosmo.h)
...
def test_flat_wcdm_distances():
    ...
    for cosmo in ASTROPY_COSMO_LIST:
        for itest in range(n_test):
            ...
            cosmo_dsps = cosmo_params.CosmoParams(cosmo.Om0, w0, wa, cosmo.h)
...
def test_cosmology_defaults():
    from .. import DEFAULT_COSMOLOGY, PLANCK15

    assert np.allclose(DEFAULT_COSMOLOGY, PLANCK15)


def test_top_level_imports():
    from .. import DEFAULT_COSMOLOGY, CosmoParams
